...
export COMPOSE_PROJECT_NAME=sylius_yoast_s_e_o_plugin
PLUGIN_NAME=sylius-yoast-s-e-o-plugin
COMPOSE=docker compose
YARN=yarn
DOCTRINE_MIGRATIONS_NAMESPACE=Acseo\SyliusYoastSEOPlugin\Migrations
...
setup_application:
	...
	$(MAKE) apply_dist
	(cd ${APP_DIR} && ${COMPOSER} require --no-progress acseo/sylius-yoast-seo-plugin="*@dev")
